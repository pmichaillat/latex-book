Lists are not very common in scientific papers, but they are sometimes useful.\footnote{Itemize and enumerate are formatted by the template with indentation and custom labels; see the style file.} This chapter presents a few possible lists.

\section{Itemized lists}\label{s:lists}
...
\section{Nnumbered lists}\label{s:numberedlists}
...
\section{Conclusion: cross-references}
