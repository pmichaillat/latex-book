This chapter displays a number of mathematical expressions to showcase the math fonts used in the template.\footnote{The template uses the same font families for text and math roman letters; see the style file for details.}
